...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://github.com/PrathameshJadhav30" style="text-decoration: none; color: #021659;">Prathamesh Jadhav</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
       ...
       st.subheader("**About - Prathamesh Arvind Jadhav**")

       st.markdown('''
        <p align='justify'>
        I am Prathamesh Arvind Jadhav, a B.Tech student in Artificial Intelligence & Data Science at Annasaheb Dange College of Engineering & Technology.
        I am passionate about solving real-world problems using technologies like Machine Learning, AI, and Full-Stack Development.
        With a strong foundation in Python, C++, Java, SQL, and DSA, I have built and contributed to multiple impactful projects including AI-driven applications, automation tools, and cloud-based systems.
       </p>

       <p align="justify">
        <b>My Work Highlights:</b> <br/><br/>
        <b>• Transaction Sync Tool</b> – Automated reconciliation for bank statements using Flask.<br/>
        <b>• DataSet Doctor</b> – Smart data preprocessing Streamlit app to boost model accuracy.<br/>
        <b>• AgriTech Assist</b> – Real-time crop selection advisor using environmental data.<br/>
        <b>• AQI Predictor</b> – Air quality forecasting for sustainable urban planning.<br/><br/>

        <b>Technical Skills:</b><br/>
        Languages: Python, C++, Java, SQL, HTML, CSS, JavaScript<br/>
        Tools & Tech: Machine Learning, Cloud Computing, DBMS, Git, Power BI<br/>
        Soft Skills: Teamwork, Leadership, Problem-Solving, Communication<br/><br/>
        
        I am always eager to learn, collaborate, and contribute to meaningful and scalable technology solutions.
       </p><br/><br/>

       <p align="justify">
        Connect with me:<br/>
        <a href="mailto:prathameshaj2004@gmail.com" style="text-decoration: none; color: grey;">📧 prathameshaj2004@gmail.com</a><br/>
        <a href="https://github.com/PrathameshJadhav30" style="text-decoration: none; color: grey;">🐱 GitHub</a><br/>
        <a href="https://leetcode.com/u/Prathamesh_Jadhav3011" style="text-decoration: none; color: grey;">🧠 LeetCode</a><br/>
        <a href="https://www.linkedin.com/in/prathamesh-jadhav-b30490259/" style="text-decoration: none; color: grey;">💼 LinkedIn</a>
      </p><br/><br/>

      <p align="justify">
        Built with 🤍 by 
        <a href="https://github.com/PrathameshJadhav30" style="text-decoration: none; color: grey;"> Prathamesh Jadhav</a> - 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        #  Admin Login
        ad_user = st.text_input("Username(admin)")
        ad_password = st.text_input("Password(admin@resume-analyzer)", type='password')
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Prathamesh ! Total %d " % values + " User's Have Used Our Tool : )")                
